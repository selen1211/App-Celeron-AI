function closedSidebar() {
  var sidebar = document.getElementById("sideBarTest");
  var layout = document.getElementById("layoutToSide");

  layout.classList.replace("layout", "close_side");
  sidebar.innerHTML =
    '<div class="cide"><div class="close_sidebar"><div class="sidebar_top"><div class="men"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" onclick="openSidebar();" class="nav-arrow" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg></div><img src="/logo.png" alt=""><p> </p></div><div class="sidebar_bottom"><a rel="noopener noreferrer" target="_blank" href="https://web.telegram.org/k/#@domacosmin"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.486 2 2 6.486 2 12v4.143C2 17.167 2.897 18 4 18h1a1 1 0 0 0 1-1v-5.143a1 1 0 0 0-1-1h-.908C4.648 6.987 7.978 4 12 4s7.352 2.987 7.908 6.857H19a1 1 0 0 0-1 1V18c0 1.103-.897 2-2 2h-2v-1h-4v3h6c2.206 0 4-1.794 4-4 1.103 0 2-.833 2-1.857V12c0-5.514-4.486-10-10-10z"></path></svg> </a></div></div></div>';
}
...
function openSidebar() {
  ...
  layout.classList.replace("close_side", "layout");
  sidebar.innerHTML = `
  <div class="sidebar">
    <div class="sidebar_top">
      <div class="men">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" fill-rule="evenodd" class="nav-arrow" onclick="closedSidebar();" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
      ...
      <p>
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="m20.38 8.57-1.23 1.85a8 8 0 0 1-.22 7.58H5.07A8 8 0 0 1 15.58 6.85l1.85-1.23A10 10 0 0 0 3.35 19a2 2 0 0 0 1.72 1h13.85a2 2 0 0 0 1.74-1 10 10 0 0 0-.27-10.44z"></path>
